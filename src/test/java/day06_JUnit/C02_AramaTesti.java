...
public class C02_AramaTesti {
    public static void main(String[] args) {
        ...
        WebElement sepette= driver.findElement(By.xpath("//div[@class='inventory_item_name']"));
        String sepetItemName= sepette.getText();
        if (ilkUrunIsmi.equals(sepetItemName)){
            System.out.println("Urun sepetete PASSED");
        }else {
            System.out.println("Urun sepetete FAILED");
        }
